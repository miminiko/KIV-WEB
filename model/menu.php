...
class myMenu {
        ...
        function menuforadmin(){
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <?php foreach($_SESSION["menu"] as $item){?>
                        <li><a href='index.php?page=category&&cat=<?php echo $item['id']?>' action="by_category">
                                <?php echo $item['category_name']  ?></a></li>
                    <?php } ?>
                </ul>
            </li>
            <li class="dropdown">
         ...
         function menuuser(){
    		...
    		<li><a href='index.php?page=home'>Home</a></li>
             <li class="dropdown">
                 ...
                 <ul class="dropdown-menu" role="menu">
                     <?php foreach($_SESSION["menu"] as $item){?>
                         <li><a href='index.php?page=category&&cat=<?php echo $item['id']?>' action="by_category"><?php echo $item['category_name']  ?></a></li>
                     <?php } ?>
                 </ul>
             </li>
